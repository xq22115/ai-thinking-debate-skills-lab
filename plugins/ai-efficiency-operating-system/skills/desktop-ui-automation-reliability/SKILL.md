...
**REQUIRED SUB-SKILL:** use `identity-session-isolation` when multiple accounts/profiles/windows coexist and `agent-containment-and-rollback` for effectful recovery actions.
