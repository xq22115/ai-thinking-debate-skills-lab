...
- **OthmanAdi/planning-with-files**: persistent working state survives compaction/restart; install route matters because a skill can be present while lifecycle hooks are absent. Verify the actual integration tier.
...
- Self-evolving skill pools can accumulate contamination; promotion needs pre-commit evaluation, rollback and non-regression.
