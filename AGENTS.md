...
Skill-authoring owner: `skills/skills/skill-authoring-engine/SKILL.md`; GitHub Copilot projection: `.github/skills/skill-authoring-engine/SKILL.md`; dedicated cloud-agent profile: `.github/agents/skill-architect.agent.md`.
